...
#   name: Video
#   url: https://youtu.be/
url_code: "https://github.com/moverseai/moai"
url_pdf: ""
url_slides: ""
url_video: ""
...
[moai](https://github.com/moverseai/moai) is a PyTorch-based AI _Model Development Kit_ (MDK) that aims to improve data-driven model workflows, design and understanding. Since it is based on established open-source packages, it can be readily used to improve most AI workflows. 

To explore [moai](https://github.com/moverseai/moai), simply install the package and follow the examples, having in mind that it is in early development alpha version, thus new features will be available soon.
